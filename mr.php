<?php 
    ...
    $query = " select * from mr_election_results_data";
      ...
      <div class="container" data-aos="fade-up">
          ...
          <div class="container" data-aos="fade-up">
            <div class="row gy-4" data-aos="fade-up">
              <h3><u>Manipur Assembly Election Results</u></h3>
              <div class="col-lg-12 order-2 order-lg-1">
                <p style="text-align: justify;">
                  The Manipur Legislative Assembly (Hindi: Manipur Vidhan Sabha) is the lower house of the bicameral legislature of the Indian state of Manipur.There are 60 seats in the house.
                </p>
              </div>
            </div>
            <br>
