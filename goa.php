<?php 
    ...
    $query = " select * from ga_election_results_data";
      ...
      <div class="container" data-aos="fade-up">
          ...
          <div class="container" data-aos="fade-up">
            <div class="row gy-4" data-aos="fade-up">
              <h3><u>Goa Assembly Election Results</u></h3>
              <div class="col-lg-11 order-2 order-lg-1">
                <p style="text-align: justify;">
                  The Goa Legislative Assembly is the unicameral legislature of the state of Goa in India. The Assembly meets at the Goa State Legislative Assembly Complex in Porvorim, Bardez. The Eighth Goa Legislative Assembly consists of 40 members.
                </p>
              </div>
            </div>
            <br>
