<?php 
    ...
    $query = " select * from ut_election_results_data";
      ...
      <div class="container" data-aos="fade-up">
          ...
          <div class="container" data-aos="fade-up">
            <div class="row gy-4" data-aos="fade-up">
              <h3><u>Uttarakhand Assembly Election Results</u></h3>
              <div class="col-lg-11 order-2 order-lg-1">
                <p style="text-align: justify;">
                  The Uttarakhand Legislative Assembly, also known as the Uttarakhand Vidhan Sabha, is a unicameral governing and law making body of Uttarakhand. It is seated at Dehradun, the winter capital, and Gairsain, the summer capital of Uttarakhand. The total strength of the assembly is 70 Members of the Legislative Assembly (MLA).
                </p>
              </div>
            </div>
            <br>
